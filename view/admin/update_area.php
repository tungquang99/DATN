                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            ...
                            <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Tên Khu Vực</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="Fullname" id="packagename" placeholder="Create Package" value="<?php echo $data['Name_city']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <img src="admin/DestinationIMG/<?php echo $data['Picture']; ?>" alt="" width="100px" height="100px" ;>
                                        <input type="file" name="Picture" id="packageimage" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <button type="submit" name="update_city" class="btn-primary btn">Cập nhật</button>
                                    </div>
                                </div>
                            </form>
