                        ...
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="Title" id="packagetype" placeholder="Tiêu đề" value="<?php echo $data['Title']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Nội dung</label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control ckeditor" name="Details" id="summernote" rows="10" cols="50" placeholder="Nội Dung" required><?php echo $data['Content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Thời gian</label>
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control1" name="Timenews" id="Timenews" placeholder="Thời Gian" value="<?php echo $data['Time_news']; ?>"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Tác giả</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="author" id="author" placeholder="Tác giả" value="<?php echo $data['author']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <img src="admin/NewsIMG/<?php echo $data['Picture'] ?>" alt="" width="200px">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <button type="submit" name="update_news" class="btn-primary btn">Cập Nhật bài viết</button>
                                    </div>
                                </div>
                        </div>
